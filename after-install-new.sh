...
if [ -e "/etc/apt/sources.list.d/virtualbox.list" ]; then
        echo "source virtualbox list already exists in '/etc/apt/sources.list.d/virtualbox.list'"
else
        sh -c 'echo "deb http://download.virtualbox.org/virtualbox/debian vivid contrib" > /etc/apt/sources.list.d/virtualbox.list'
	wget -q https://www.virtualbox.org/download/oracle_vbox.asc -O- | sudo apt-key add -
        echo "source virtualbox list was included in '/etc/apt/sources.list.d/virtualbox.list'"
fi
